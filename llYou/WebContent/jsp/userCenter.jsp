...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-body">
			...
			<div style="padding: 10px; background-color: #F2F2F2;display:inline-block;">
				<div class="layui-row layui-col-space15">
							...
							<div class="layui-card-body" style="display: inline-block;">
								<table>
									...
									<tbody>
										<tr class="uc-tr">
											<td>2020.12</td>
											<td>国家级大学生创新创业项目立项</td>
										</tr>
										<tr class="uc-tr">
											<td>2020.05</td>
											<td>第四十四届国际大学生程序设计竞赛亚洲区预赛瞎编站优胜奖</td>
										</tr>
										<tr class="uc-tr">
											<td>2019.10</td>
											<td>第九届大学生服务外包创新创业大赛不知道几等奖</td>
										</tr>
									</tbody>
								</table>
							</div>
					...
					<div class="layui-col-md12">
						<div class="layui-card">
							<div class="layui-card-header">
								<strong class="layui-breadcrumb" lay-separator="|"> 
								<a href="#" style="color:#009345!important;">学历信息</a>
								<a href="#">就职信息</a>								
								</strong>
							</div>
							...
							<div class="layui-card-body">
								...
								<div style="width: 48%; padding-left: 10px;display:inline-block;">
								<div class="layui-card-header">
									<strong> 
									综合能力评价							
									</strong>
		...
		option = {
			...
			series : [ {
				...
				axisLine : {
					lineStyle : {
						width : 6,
						color : [ [ 0.25, '#FF6E76' ], [ 0.5, '#FDDD60' ],
								[ 0.75, '#58D9F9' ], [ 1, '#7CFFB2' ] ]
					}
				},
				pointer : {
