							...
							<div class="layui-card-body">
								...
								<div class="form-row">
									<div class="form-group col-md-4">
										<label>账号名称</label> <input class="form-control"
											aria-describedby="emailHelp" placeholder="请输入账号"> <small
								...
								<div class="form-row">
									<div class="form-group col-md-4">
										<label>密码</label> <input class="form-control" type="password"
											placeholder="请输入密码"> <small id="emailHelp"
								...
								<div class="form-group">
									<div class="form-row"
										...
										<a href="userReg2.jsp" class="layui-btn layui-btn-normal"><span
											style="padding: 0 15px;">下一步</span></a>
									</div>
								</div>
