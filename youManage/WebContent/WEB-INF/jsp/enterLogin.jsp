...
<body>
	...
	<form class="form-signin">
		<div class="text-center mb-4">
			...
			<h1 class="h3 mb-3 font-weight-normal">企业用户登录</h1>
		</div>

		<div class="form-label-group">
			<img style="display:inline-block;" src="img/user.png">
			<input style="display:inline-block;width:80%;" type="text" class="form-control"  placeholder="用户登录" required
				autofocus> 
		</div>
		...
		<div class="form-label-group">
			<img style="display:inline-block;" src="img/user.png">
			<select style="display:inline-block;width:80%;" class="form-control" >
		...
		<p class="mt-5 mb-3 text-muted text-center">
			&copy; <a href="https://github.com/ZUFEcsc">GitHub</a> | <a href="#">回到主页</a>
		</p>
